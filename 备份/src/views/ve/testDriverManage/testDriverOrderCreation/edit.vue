...
<section class="testDriver">
  ...
  >
    ...
    <div class="filter-container filter-params">
      <h3 :style="styleObj">车型配置</h3>
      <el-row :gutter="26" ref="vailComponentList3">
        <component
    ...
    <div class="filter-container filter-params">
      <h3 :style="styleObj">
        车辆信息
        <el-button @click="rowAdd"  plain>添加</el-button>
      </h3>
        ...
        tableComponents3:
          [
            ...
            },
            {
              compKey: 'compKey18',
              labelName: '体验中心',
              codeField: 'explorationCenter',
              component: () => import('@/components/org/experienceCenter/index.vue'),
              type: 'dropdownList',
              isMust: true,
              isRequire:true,
              span: 8
