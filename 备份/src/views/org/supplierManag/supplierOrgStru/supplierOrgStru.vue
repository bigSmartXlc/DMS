        ...
        <div class="filter-container filter-params">
          <el-row :gutter="28">
            ...
            <el-col :span="20">
              ...
              <el-select
                collapse-tags
                :disabled="editQuery.isEnable==='0'?true:false"
                filterable
            ...
            <el-col :span="20">
              <div class="orgManageBtn">
                ...
                <el-button type="primary" size="small"   icon="iconfont  icon-preservation" @click="saveNew()">{{$t('sys.button.save')}}</el-button>
                <!-- /*保存*/ -->
                <el-button size="small"   icon="iconfont  icon-reset" @click="reset()">{{$t('sys.button.reset')}}</el-button>
              </div>
            </el-col>
          </el-row>
        </div>
      ...
      if (that.$utils.isEmpty(that.editQuery.orgCode)) {
        that.$message({
          message:
            "供应商编码" +
            " " +
            this.$t("org.label.NotNull") /*供应商编码不能为空*/,
          type: "warning",
          duration: 2000
        });
        return;
      ...
      if (that.$utils.isEmpty(that.editQuery.orgName)) {
        ...
        that.$message({
          message:
            "供应商名称" +
            " " +
            this.$t("org.label.NotNull") /*供应商名称不能为空*/,
          type: "warning",
          duration: 2000
        });
        return;
