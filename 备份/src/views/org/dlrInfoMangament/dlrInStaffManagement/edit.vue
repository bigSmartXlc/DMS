...
export default {
    ...
    return {
      ...
      staticTableComponents: [
        ...
        },
        {
          ...
          codeField: 'userName',
          isShow: null,
          parentFileds: 'show:userName1-1,disabled:updateControlId-userName',
          disabled: null,
          component: () => import('@/components/org/commonInput'),
          type: 'inputText',
          isMust: true
        ...
        //   /*创建登录名*/
        //   codeField: "userName",
        //   disabled: this.popupsState == "add" ? false : true,
        //   isRequire: true,
        //   component: () => import("@/components/org/commonInput"),
        //   type: "inputText",
        //   isMust: true
      ...
      formField: {
        ...
        empCode: '',
        empName: '',
        orgName: this.showOrgName === '' ? this.dynamicEditRowData.orgName : this.showOrgName,
        stationId: '',
        genderCode: '',
        userName: '',
        userName1: '1',
  ...
  methods: {
    ...
    save1() {
      ...
      // 除经销商账号 dirID都为null    经销商账号:h2902等
