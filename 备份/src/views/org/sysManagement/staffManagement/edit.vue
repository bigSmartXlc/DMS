      ...
      <div class="filter-container filter-params">
        <el-row ref="vailComponentList" :gutter="26">
          <component
            ...
            :collapse-tags="comp.collapseTags"
...
export default {
  ...
  data() {
    const viewPageCode = 'orgstaffManagement-Edit'
    return {
      popupsPageCode: 'orgstaffManagement-Edit',
      businessDates: '',
      driverDates: '',
      leaveDates: '',
      employDates: '',
        ...
        this.$ConfigCache.CacheConfig.cacheData[viewPageCode].formComponents.length > 0
          ...
          : [
            ...
            },
            {
              ...
              labelName: '创建用户名',
              /* 是否创建登录名*/
              codeField: 'userName1', // 只用于判断
              parentFileds: 'disabled:updateControlId-userName1',
              disabled: null,
              isRequire: true,
            ...
            },
            {
              ...
              /* 登录账号名*/
              codeField: 'userName',
              parentFileds: 'show:userName1-1-0,disabled:updateControlId-userName',
              disabled: null,
              component: () => import('@/components/org/commonInput'),
              type: 'inputText',
              isMust: true
            },
            {
              ...
              /* 登陆密码*/
              codeField: 'password',
              parentFileds: 'show:userName1-1-0',
              component: () => import('@/components/org/commonInput'),
              type: 'inputText',
              inputType: 'password',
              isMust: true,
            ...
            {
              compKey: 'compKey36',
              labelName: '生效日期', // 用户生效日期
              codeField: 'effectDate',
            ...
            {
              compKey: 'compKey37',
              labelName: '失效日期', // 用户失效日期
              codeField: 'diseffectDate',
              component: () => import('@/components/org/datePicker/dateTimePick'),
              format: 'yyyy-MM-dd HH:mm:ss',
              type: 'datePicker',
              isRequire: true,
            ...
            },
            {
              ...
              codeField: 'isFrozen',
              disabled: null,
              parentFileds: 'disabled:isEnable-isFrozen-1-true',
              component: () => import('@/components/org/LookupValue'),
              type: 'dropdownList',
              isMust: true
              // 冻结状态
  ...
  watch: {
    ...
    //   handler: function() {
    //     let that = this
    //     const comps = that.tableComponents.filter(o => o.codeField === 'userName' || o.codeField === 'userName1')
    //     if (this.popupsState === "edit") {
    //       for (let i = 0; i < comps.length; i++) {
    //         comps[i].disabled = true
    //       }
    //     } else if (this.popupsState === "add") {
    //       for (let i = 0; i < comps.length; i++) {
    //         comps[i].disabled = false
    //       }
    //     }
    //   }
    // }
  ...
  methods: {
    ...
    onCreated() {
      ...
      if (this.popupsState === 'edit') {
        ...
        this.formField.userName = this.dynamicEditRowData.userName
        if (this.formField.userName) {
          this.formField.userName1 = '1'
        } else this.formField.userName1 = '0'
    ...
    save1() {
      ...
      this.save(saveObj, function() {
        that.formField.userName = userNames
      })
