            ...
            <el-col :span="20">
              <div class="orgManageBtn">
                <div class="promptSpan">
                  <span>提示：经销商状态一旦改为否则不能逆转操作</span>
                </div>
                <el-button
                  type="primary"
                  size="small"
...
export default {
  ...
  data() {
    return {
      ...
      g_groupCode: this.$t("org.label.dlrCode") /*集团编码*/,
      isEnableSpan: 20,
      defaultProps: {
        children: "children",
        label: "orgName"
  ...
  methods: {
    ...
    getGroupCode(type) {
      switch (type) {
        case "0":
          this.g_groupName = this.$t("org.label.manufacturerName"); /*厂商*/
          this.g_groupCode = this.$t("org.label.vendorCode");
          break;
        case "1":
          this.g_groupName = this.$t("org.label.dlrName"); /*经销商*/
          this.g_groupCode = this.$t("org.label.dlrCode");
          break;
        case "2":
          this.g_groupName = this.$t("org.label.orgName1"); /*集团*/
          this.g_groupCode = this.$t("org.label.orgCode");
          break;
        case "3":
          this.g_groupName = this.$t("org.label.supplier"); /*供应商*/
          this.g_groupCode = this.$t("org.label.supplier"); /*集团编码*/
          break;
        case "4":
          this.g_groupName = this.$t("org.label.region"); /*大区*/
          this.g_groupCode = this.$t("org.label.region"); /*集团编码*/
          break;
        case "5":
          this.g_groupName = this.$t("org.label.smallAreaName"); /*小区*/
          this.g_groupCode = this.$t("org.label.smallAreaName"); /*集团编码*/
          break;
        case "6":
          this.g_groupName = this.$t("org.label.regionName"); /*区域*/
          this.g_groupCode = this.$t("org.label.regionName"); /*集团编码*/
          break;
        case "7":
          this.g_groupName = this.$t("org.label.carBrand"); /*品牌*/
          this.g_groupCode = this.$t("org.label.carBrandCode"); /*集团编码*/
          break;
        case "8":
          this.g_groupName = this.$t("org.label.DeptName2"); /*部门*/
          this.g_groupCode = this.$t("org.label.DeptCode"); /*集团编码*/
          break;
      }
    },
    handleNodeClick(a, b, c) {
      this.getGroupCode(a.orgBelongType);
