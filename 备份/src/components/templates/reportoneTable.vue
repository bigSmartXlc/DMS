...
<template>
  ...
  >
      ...
      >
        ...
        >
          <mix-button
            ...
            :isShowMore="isShowMoreBtn"
            :dynamicToggleParam="dynamicToggleParam"
          ></mix-button>
          <mix-button
    ...
    >
      ...
      >
      <el-table-column
        v-for="(propscol, propscolindex) in props.propsChildren"
        :label="propscol.label"
        :key="`col_${propscolindex}`"
        :width="propscol.width || null"
        :prop="propscol.prop"
        :align="dropTableCols[index].align||'center'"
        :header-align="dropTableCols[index].headerAlign||'center'"
      >
        ...
        <template slot-scope="scope">
          <slot
            ...
            :row="scope.row"
          ></slot>
          <span :key="compInColsKey"  v-if="!dropTableCols[index].isSlot && dropTableCols[index].isComponent === true && dropTableCols[index].comps">
            <component
    ...
    <div
      ...
      @click="leftScroll(3)"
    ><i class="el-icon-caret-left"></i></div>
    <div
      v-show="isOver"
      id="scrollRightEle"
      class="page-ScrollButton"
