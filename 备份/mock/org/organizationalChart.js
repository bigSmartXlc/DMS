...
// 组织架构保存
const mdmOrgRelationRealMutationSave = Mock.mock({
  'result': '1',
  'data': {
    'mdmOrgRelationRealMutationSave': {
      'result': '1',
      'records': 1,
      'msg': '1',
      'rows': []
...
export default [
  ...
  {
    url: orgApis.mdmOrgRelationRealMutationSave.APIUrl + cH + 'v=' + orgApis.mdmOrgRelationRealMutationSave.ServiceCode,
    type: 'post',
    response: config => {
      return mdmOrgRelationRealMutationSave
    }
  }
